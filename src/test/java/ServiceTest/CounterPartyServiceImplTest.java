...
class CounterPartyServiceImplTest {
    ...
    void makeTransactionsAndGetList() {
        ...
        String actualTransactionsList = "{\"cardNumberFrom\" : \"2222222222222222\", \"cardNumberTo\" : \"1111111111111111\", \"sum\" : 30}\n";
        Assertions.assertEquals(transJson, actualTransactionsList);
    }
}